...
const success = () => {
  ...
  message.success('Slot assigning Updated  successfully');
};
...
render() {
    return(
        ...
        <div className="right">
        <button type="button" class="btn btn-primary" onClick= {this.handleClick}>Update</button>
        </div>
