...
const success = () => {
  ...
  message.success('Slot assigned  successfully');
};
...
class assignslots extends Component{
...
render() {
    return(
        ...
        <ul>
         ...
         <label for="NewPassword" class="form-label" >ID </label>
           ...
           <br></br>
            ...
            <input typeclass="form-control" id="uniqueID2" placeholder="Slot id"></input>
            </div>
        ...
        <div className="right">
        <button type="button" class="btn btn-primary" onClick= {this.handleClick}>Assign</button>
        </div>
